...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "pipelines" do |pipelines|
    ...
    pipelines.vm.provision "shell", path: "add-metricbeat.sh"
  ...
  config.vm.define "containers" do |containers|
    ...
    containers.vm.provision "shell", path: "add-metricbeat.sh"
  ...
  config.vm.define "monitoring" do |monitoring|
    ...
    monitoring.vm.provision "shell", path: "add-es-l-k.sh"
